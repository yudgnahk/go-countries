...
// NOTE: Historical (formerly existing) countries such as the USSR,
// Yugoslavia, Czechoslovakia, East Germany, Serbia and Montenegro, and
// Zaire are maintained in a separate file (historical_countries.go) and
// are NOT generated by this crawler. Update that file directly to add,
// remove, or modify historical entries.
